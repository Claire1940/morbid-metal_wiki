...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Morbid Metal Wiki',
    description: 'Morbid Metal Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Morbid Metal Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Morbid Metal Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Morbid Metal Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Valve Corporation (Steam) or the developers of Morbid Metal. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@morbid-metal.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@morbid-metal.wiki</a>
            </p>
            <p>
