...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Morbid Metal Wiki",
    description: "Read the Terms of Service for Morbid Metal Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    keywords: [
      'terms of service',
      "Morbid Metal Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Morbid Metal Wiki",
      description: "Terms and conditions for using Morbid Metal Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Morbid Metal Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Morbid Metal Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Morbid Metal Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Morbid Metal Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Morbid Metal". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Morbid Metal Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Morbid Metal. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Morbid Metal Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Morbid Metal. We use such
            ...
            <p>
              ...
              you and Morbid Metal Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@morbid-metal.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@morbid-metal.wiki</a>
            </p>
            <p>
