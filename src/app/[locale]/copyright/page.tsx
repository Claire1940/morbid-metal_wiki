...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Morbid Metal Wiki',
    description: 'Copyright and intellectual property information for Morbid Metal Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Morbid Metal Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Morbid Metal Wiki',
      description: 'Copyright and intellectual property information for Morbid Metal Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Morbid Metal Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Morbid Metal Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Morbid Metal Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Morbid Metal Developers</strong> - Creators of the Morbid Metal game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Morbid Metal</strong> - Trademark of the game developers</li>
              <li><strong>Morbid Metal Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Morbid Metal Wiki.
            </p>
            ...
            <p>
              ...
              Morbid Metal Wiki<br />
              Email: <a href="mailto:dmca@morbid-metal.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@morbid-metal.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Morbid Metal Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Morbid Metal Wiki (morbid-metal.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@morbid-metal.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@morbid-metal.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@morbid-metal.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@morbid-metal.wiki</a>
            </p>
            <p>
